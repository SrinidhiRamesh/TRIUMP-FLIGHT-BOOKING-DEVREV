...
<body background="6.jpg"  >
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header"  >
        <header class="mdl-layout__header"  style="background-color:#413543;">
            <div class="mdl-layout__header-row" style="background-color:#413543;">
                <!-- Title -->
                <span class="mdl-layout-title" >Signup</span>
                <!-- Add spacer, to align navigation to the right -->
                <div class="mdl-layout-spacer"  ></div>
                <!-- Navigation. We hide it in small screens. -->
                <nav class="mdl-navigation mdl-layout--large-screen-only" style="background-color:#413543;">
        ...
        <div class="mdl-layout__drawer" style="background-color:#413543;">
            <span class="mdl-layout-title"  style="background-color:#413543;">Signup</span>
            <nav class="mdl-navigation"  style="background-color:#413543;">
                <a class="mdl-navigation__link" href="home.php">Home</a>
...
<br><br>
                        <div class="demo-card-wide mdl-card mdl-shadow--16dp" style="width:650px;">
                            <b> <div class="mdl-shadow--16dp" style="background-color:#413543">
                        <br>
                        <div class="mdl-typography--title" style="color:#ffffff;background-color:#413543;">Name</div>
                        <br><br>
                        </div><br><br>
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <label class="mdl-textfield__label" for="Last-Name">Last Name</label><br><br>
                            </div>    
                                <br>
                                <div class="mdl-shadow--16dp" style="background-color:#413543">
                        <br>
                        <div class="mdl-typography--title" style="color:#ffffff;background-color:#413543;">Email Id</div>
                        <br><br>
                        </div><br><br>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" >
                                <input class="mdl-textfield__input" type="text" id="Email" name="Email">
                                <label class="mdl-textfield__label" for="Email">Email Id</label><br><br>
                            </div>
                            <br>
                            
                                <div class="mdl-shadow--16dp" style="background-color:#413543;">
                        <br>
                        <div class="mdl-typography--title" style="color:#ffffff;background-color:#413543;">Date Of Birth</div>
                        <br>
                        </div><br><br>
                        ...
                        <br><div class="mdl-shadow--16dp" style="background-color:#413543;">
                        <br>
            ...
            <div class="mdl-shadow--16dp" style="background-color:#413543;">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <label class="mdl-textfield__label" for="Nationality">Nationality</label><br><br>
                </div>
                <center>
                    <br><div class="mdl-shadow--16dp" style="background-color:#413543;">
                        <br>
            ...
            <br><br>
                ...
                <b> <br><div class="mdl-shadow--16dp" style="background-color:#413543">
                        <br>
                        <div class="mdl-typography--title" style="color:#ffffff">Mobile No</div>
                        <br>
                        </div></b><br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><br><br>
                    <input class="mdl-textfield__input" type="text" id="Mobile-No" name="Mobile-No">
                    <label class="mdl-textfield__label" for="Mobile-No">Mobile No</label><br><br>
                </div>
                <b> <br><div class="mdl-shadow--16dp" style="background-color:#413543">
                        <br>
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><br><br>
                    ...
                    <label class="mdl-textfield__label" for="Password">Password</label><br><br>
                </div>
                <b> <br><div class="mdl-shadow--16dp" style="background-color:#413543">
                        <br>
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><br><br>
                    ...
                    <label class="mdl-textfield__label" for="r_password">Password</label><br><br>
                </div>
                <div class="mdl-shadow--16dp" style="background-color:#413543"><br>
                <input type="Submit" style="background-color:#E4D0D0;color:black;" name="signup" value="Sign Up" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
