...
<body background="33.jpg">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header" style="background-color:#D5B4B4;">
            <div class="mdl-layout__header-row">
                <!-- Title -->
                <span class="mdl-layout-title" style="color:black;">Delete a user</span>
        ...
        <div class="mdl-shadow--16dp" style="background-color:#D5B4B4">
                        <br>
...
<br><br>
<div class="mdl-shadow--16dp" style="background-color:#D5B4B4 "><br>
<input type="Submit" style="background-color:#FFEAEA;color:black;" name="cancel" value="Delete the selected user" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
