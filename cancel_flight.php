...
<body background="airplane.jpg">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header" style="background-color:#675D50;">
        ...
        <div class="mdl-shadow--16dp" style="background-color:#675D50">
                        <br>
...
<br><br>
<div class="mdl-shadow--16dp" style="background-color:#675D50"><br>
<input type="Submit" name="cancel" style="background-color:#675D50;color:white;" value="Cancel the selected Flight" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
                
                    </button>
					<button onclick="window.location.href ='logged_admin.php';"><h5>Back</button>
                    <br><br>
                    </div>
                    </div>
                    <br><br><br>
