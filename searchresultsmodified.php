...
?>
<html>
<title>Choosing Departure Flight</title>
<head>
...
<body background="40.jpg">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header" style="background-color:#002B5B;">
        ...
        <div class="mdl-shadow--16dp" style="background-color:#002B5B">
                        <br>
...
<br><br>
<div class="mdl-shadow--16dp" style="background-color:#002B5B"><br>
                            <button style="background-color:#A5D7E8;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
                        <div class="mdl-typography--subtitle" style="background-color:#A5D7E8;color:black;font-weight:bolder" name="Search">Book Now</div>
                    </button>
                    <br><br>
                    </div>
                    
            <div class="mdl-shadow--16dp" style="background-color:#A5D7E8"><br>
            <a class="mdl-navigation__link" href="home.php"><div class="mdl-typography--title" style="color:black">Search Other Flights</div></a>
                    <br>
                    </div>
                    </div>
        </form>
