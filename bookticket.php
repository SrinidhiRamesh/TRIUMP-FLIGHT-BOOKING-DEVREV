...
<body style="background-color:#7DB9B6;">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <div class="demo-card-wide mdl-card mdl-shadow--16dp">
                        <div class="mdl-shadow--16dp" style="background-color:#1F8A70">
                        <br>
        ...
        <br><br>
        <div class="mdl-shadow--16dp" style="background-color:#1F8A70"><br>
<div class="mdl-shadow--16dp" style="background-color:#B6EADA;"><br>
                        <a class="mdl-navigation__link" href="home.php"><div class="mdl-typography--title" style="color:#000000;font-size:15px;background-color:#B6EADA;"><b>Home</b></div></a>
                        <br>
                        </div>
