...
<body background="45.jpg">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header" style="background-color:#0E8388;">
        ...
        <div class="mdl-shadow--16dp" style="background-color:#0E8388">
                        <br>
                        <div class="mdl-typography--title" style="color:#ffffff">Choose Return Flight</div>
                        <br>
                        </div>
        <br><br>
...
<br><br>
<div class="mdl-shadow--16dp" style="background-color:#0E8388"><br>
                            <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="background-color:#CBE4DE;">
                        <div class="mdl-typography--subtitle" style="color:black;font-weight:bolder;background-color:#CBE4DE;" name="Search">Book Now</div>
                    </button>
                    <br><br>
                    </div>
                    
            <div class="mdl-shadow--16dp" style="background-color:#0E8388"><br>
            <a class="mdl-navigation__link" href="home.php"><div class="mdl-typography--title" style="color:white;">Search Other Flights</div></a>
                    <br>
                    </div>
                    </div>
        </form>
