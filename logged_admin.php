...
?>
    ...
    <body background="30.gif">
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
            <header class="mdl-layout__header" style="background-color:#EAB2A0;">
                <div class="mdl-layout__header-row" style="background-color:#EAB2A0;">
                    <!-- Title -->
                    <span class="mdl-layout-title" style="color:black;">Administrator</span>
            ...
            <br><br>
                ...
                <div class="demo-card-wide mdl-card mdl-shadow--16dp" style="width:400px">
                            <div class="mdl-shadow--16dp" style="background-color:#EAB2A0"><br>
                                <h3 style="color:black">
                                    Flights
                                </h3>
                            </div>
                            <div class="mdl-shadow--16dp" style="background-color:#FFD89C"><br>
